...
function IntelligentAssistant({ onMedia, onFilters }) {
  ...
  return (
    <div className="w-full px-4 flex justify-center mt-8 mb-4">
      <div className="w-full max-w-7xl flex items-stretch gap-10 min-h-[300px]">
        
        {/* Left Ad */}
        <div className="hidden lg:flex flex-1 h-full bg-gray-900 border border-white/10 rounded-lg text-white text-sm items-center justify-center">
        ...
        {/* Assistant */}
        <div className="w-full max-w-sm flex-shrink-0 flex justify-center">
          <div className="w-full bg-zinc-900/80 backdrop-blur-lg border border-zinc-700/40 rounded-2xl shadow-xl p-5 space-y-5 flex flex-col justify-between h-full">
